...
if __name__ == "__main__":
   ...
   circle0 = plt.Circle((antennas.iloc[0].y, 5-antennas.iloc[0].x), d.iloc[1,0], color='r', fill=False)
   circle1 = plt.Circle((antennas.iloc[1].y, 5-antennas.iloc[1].x), d.iloc[1,1], color='r', fill=False)
   circle2 = plt.Circle((antennas.iloc[2].y, 5-antennas.iloc[2].x), d.iloc[1,2], color='r', fill=False)
   circle3 = plt.Circle((antennas.iloc[3].y, 5-antennas.iloc[3].x), d.iloc[1,3], color='r', fill=False)
